...
mammal_frug <- "/Users/bethgerstner/Desktop/MSU/Zarnetske_Lab/Data/Elton_Traits_birds_mammals/CSA_all_species/CSA_mam_frug.csv"
# match the names 
...
bird_frug <- "/Users/bethgerstner/Desktop/MSU/Zarnetske_Lab/Data/Elton_Traits_birds_mammals/CSA_all_species/CSA_bird_frug.csv"
# match the names 
...
occ_download(
  sprintf("taxonKey = %s", paste0(gbif_taxon_keys_birds, collapse = ",")),
  type="in", 
  format = "SIMPLE_CSV", 
  user=user,pwd=pwd,email=email)
