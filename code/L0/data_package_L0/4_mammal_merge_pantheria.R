...
#Overview: This script merges PanTHERIA traits into the mammal database in the same fashion as the "2_external_database_merge.R" script, except for the smaller subset of species.

#Data Input: PanTHERIA dataset (Jones et al. 2009), mam_frug_montane.csv

#Data Output: list of species that did not merge correctly - mamm_pantheria_na_original.csv; final_mammal_dataset.csv

#Date: Oct 10th, 2020

#Modified: Oct 15th, 2021

#Requires: "3_montane_frugivore_subset.R" should be run first.


#load library
library(dplyr)

#Read in PanTHERIA dataset
