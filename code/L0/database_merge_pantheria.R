...
write.csv(mamm_pantheria_original, "/Volumes/GoogleDrive/Shared drives/SpaCE_Lab_FRUGIVORIA/L1/working_databases/database_csv_2_9_21/pantheria_added_mammals/mamm_original_pantheria.csv")

mamm_pantheria <- merge.data.frame(mont_mam_new, pantheria, by= "IUCN_species_name", all.x=TRUE)
