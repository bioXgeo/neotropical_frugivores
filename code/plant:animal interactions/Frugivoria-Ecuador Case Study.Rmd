...
#Issue with pulling in habitat for multiple species at once (downloaded for whole word on IUCN website) - Check with Pat about an easy way of doing this
```{r}

# Read in mammal habitat data
