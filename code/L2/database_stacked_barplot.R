...
#Purpose: To analyze trait composition of the database. This script creates a stacked barplot of each database component. The numbers were calculated as the last step of script 'montane_database_stats'.

#Code reference: database_stacked_barplot
