...
# IF the save file is here, read that, otherwise pull plant species list from BIEN
    # and save that
    if(file.exists("Ecuador_species_list.csv")){
        Ecuador_species_list <- read.csv("Ecuador_species_list.csv")
    } else {
...
Ecuador_plants <- read_sf("C:/Users/hj152/Documents/R/EcuadorPlantSpeciesMaps/Aa_argyrolepis.shp")
```
