...
Pull out all bird and mammal forest species and then pull those from the IUCN shapefile. Look up code to make a map of stacked ranges. Turn the polygons to a grid and add them up
```
