...
#Overview: Derives range based traits from both IUCN and BirdLife International spatial databases. 
# Here we calculate range size for all species and, in a addition, calculate mean annual temperature over range, mean annual precipitation over range, 
